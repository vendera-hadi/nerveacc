...
<div class="row">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#">Kirim Uang</a></li>
        </ul>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                              ...
                              <input type="text" name="trbank_recipient" class="form-control" value="{{$trbank->trbank_recipient}}">
                          </div>
                       </div>
