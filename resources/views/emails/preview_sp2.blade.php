                ...
                <tr>
                    ...
                    <td width="40%">
                        <table width="100%">
                            ...
                            <tr>
                                <td>No. XXX/SP2/{{date('m')}}/{{str_slug(@$company->comp_name, '-')}}/{{date('Y')}}</td>
                            </tr>
            ...
            <table style="margin-top: 70px">
                <tr>
                    <td style="text-align: justify;">
                       <p>Dengan Hormat,<br><br>Bersama ini kami mengingatkan kembali kerjasamanya, bahwa tagihan utilitas dan tagihan iuran pengelolaan lingkungan Bapak/Ibu sampai dengan bulan <b>Januari 2018</b> sudah jatuh tempo per tanggal <b>15 Februari</b>. Bagi Bapak/Ibu yang belum melakukan pembayaran tagihan sampai bulan Februari, kami berikan tenggang waktu sampai dengan tanggal <b>01 Maret 2018.</b> Guna menghindari denda
...
telah diperhitungkan sebelum tanggal <b>01 Maret 2018</b>
                        <br><br>
                        <table width="100%">
                            <tr>
                                <td width="50%">
