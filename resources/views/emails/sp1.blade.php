                ...
                <tr>
                    ...
                    <td width="40%">
                        <table width="100%">
                            ...
                            <tr>
                                <td>No. {{@$invoice->id}}/SP1/{{date('m')}}/{{str_slug(@$company->comp_name, '-')}}/{{date('Y')}}</td>
                            </tr>
...
telah diperhitungkan sebelum tanggal <b>{{date('d', strtotime('+7 day',strtotime($invoice->inv_duedate)))}} {{convertbulan(date('m', strtotime('+7 day',strtotime($invoice->inv_duedate))))}} {{date('Y', strtotime('+7 day', strtotime($invoice->inv_duedate)))}}</b>
                        <br><br>
                        <table width="100%">
                            <tr>
