    ...
    <div class="container spark-screen">
        <div class="row">
            <div class="col-md-11">
                ...
                <!-- template tabel -->
                <table id="dg" title="Faktur Invoice" class="easyui-datagrid" style="width:100%;height:100%">
                    <!-- kolom -->
                    <thead>
                        <tr>
                            <!-- tambahin sortable="true" di kolom2 yg memungkinkan di sort -->
                            <th field="inv_number" width="50" sortable="true">No. Faktur</th>
...
var get_url2 = "{{route('faktur.getdetail')}}";
