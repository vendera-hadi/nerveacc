        ...
        <tbody>
            @if(!empty($invoice_data))
                ...
                <tr class="<?php echo $class;?>">
                    ...
                    <td><input type="number" name="data_payment[totalpay][{{$inv_id}}]" value="0" max="<?php echo (int)$value->inv_outstanding ?>" placeholder="Amount" class="form-control paid-amount" disabled=""></td>
                </tr>
                @endforeach
            @else
            <tr>
