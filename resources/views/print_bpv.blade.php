...
<body>
    ...
    <?php
    $amount = $inv['amount'];
    $ap_date = date('d-M-Y', strtotime($inv['payment_date']));
    $spl_name = $inv['spl_name'];
    $ptype = $inv['paymtp_name'];
    ?>
    <div class="page">
        <div class="subpage">
                    ...
                    <td width="60%">
                        <table width="100%">
                            <tr>
                                ...
                                <td>: <?php echo '<strong>'.$spl_name.'</strong>'; ?></td>
                            </tr>
                        </table>
                    </td>
                    <td width="40%">
            ...
            <table width="100%" style="border-collapse: collapse; border: solid 1px; line-height: 18px;">
                ...
                <tr>
                    ...
                    <td style="padding-left:15px;border: solid 1px; vertical-align:center;"><?php echo $inv['note'];?></td>
