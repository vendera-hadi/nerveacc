...
@section('contentheader_breadcrumbs')
	<ol class="breadcrumb">
        ...
        <li class="active">Open Entries</li>
    </ol>
@stop
          	...
          	<div class="col-md-12">
          		<div class="box box-primary">
		            <div class="box-header with-border">
		              <h3 class="box-title">Open Entries</h3>
		            </div>
...
$(document).ready(function() {
	...
	$('#formClosing').submit(function(e){
		e.preventDefault();
		var url = '{{route('opentry.update')}}';
		if(confirm('Apakah anda yakin ingin melakukan Open Entry sekarang? (Piutang dibulan yg dipilih akan di alokasikan ke bulan yang dipilih)')){
