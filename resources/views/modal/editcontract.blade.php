    ...
    <form method="POST" id="formEditCostItem">
        <table id="editTableCost" width="100%" class="table table-bordered">
            ...
            <tr class="text-center">
                ...
                <td><input type="number" name="order[]" class="form-control" style="width: 60px"  value="{{$cdt->order}}" style="width: 60px"></td>
                ...
                <td>
                    <table style="width:100%">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                @if(in_array($cdt->cost_id,[1,2]))
                                    <input type="hidden" name="inv_type[]" value="1">{{$invoice_utility}}
                                @else
...
<script>
    ...
    $('#clickCostItemEdit').click(function(){
        ...
        costId = $('#selectCostItemEdit option:selected').data('costid');
        ...
        if(!flag){
            ...
            $.post('{{route('cost_item.getDetail')}}', {id: costItem}, function(result){
                $('#editTableCost').append('<tr class="text-center"><input type="hidden" name="contr_id[]" value="'+contractID+'"><input type="hidden" name="costd_id[]" class="costdid" value="'+result.id+'"><td><input type="number" name="order[]" class="form-control" style="width: 60px" value="0" style="width: 60px"></td><td>'+costItemName+'</td><td><table style="width:100%"><tr><td style="text-align:right"><strong>Name</strong></td><td width="40">:</td><td style="text-align:left">'+result.costd_name+'</td></tr><tr><td style="text-align:right"><strong>Unit</strong></td><td>:</td><td style="text-align:left">'+result.costd_unit+'</td></tr><tr><td style="text-align:right"><strong>Cost Rate</strong></td><td>:</td><td style="text-align:left">'+result.costd_rate+'</td></tr><tr><td style="text-align:right"><strong>Cost Burden</strong></td><td>:</td><td style="text-align:left">'+result.costd_burden+'</td></tr><tr><td style="text-align:right"><strong>Cost Admin</strong></td><td>:</td><td style="text-align:left">'+result.costd_admin+'</td></tr><tr><td style="text-align:right"><strong>Use Meter</strong></td><td>:</td><td style="text-align:left">'+result.costd_ismeter+'</td> </tr><tr><td style="text-align:right"><strong>Invoice Type</strong></td><td>:</td><td>'+invtypeSelection+'</td></tr><tr><td style="text-align:right"><strong>Billing Period</strong></td><td>:</td><td><select name="period[]" class="form-control">'+periods+'</select></td></tr></table></td><td><a href="#" class="removeCost"><i class="fa fa-times text-danger"></i></a></td></tr>');
