...
<table class="table table-bordered">
	...
	<tr>
		<td><center><input type="radio" name="@if($edit){{'unitedit'}}@else{{'unit'}}@endif" data-name="{{$unit->unit_code." ".$unit->unit_name}}" data-vaccount="{{$unit->virtual_account}}" value="{{$unit->id}}"></center></td>
