          		...
          		<table id="dg" title="Currency" class="easyui-datagrid" style="width:100%;height:100%" toolbar="#toolbar">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th field="currency" width="50" sortable="true">Currency Code</th>
                            <th field="value" width="50" sortable="true">Value (to IDR)</th>
                        </tr>
                    </thead>
                </table>
                <!-- end table -->
                ...
                <div id="dlg" class="easyui-dialog" style="width:60%"
                    ...
                    <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px">
                        ...
                        <div style="margin-bottom:10px">
                            <input name="currency" class="easyui-textbox" required="true"  label="Currency Code (3 digit):" style="width:100%">
                        </div>
                        <div style="margin-bottom:10px">
                            <input name="value" class="easyui-textbox" required="true" label="Value (to IDR):" style="width:100%">
                        </div>
...
<script type="text/javascript">
        ...
        var get_url = "{{route('kurs.get')}}";
        var insert_url = "{{route('kurs.insert')}}";
        var update_url = "{{route('kurs.update')}}";
        var delete_url = "{{route('kurs.delete')}}";
