...
class SendSP1 extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sp:sendsp1';
     ...
     * @var string
     */
    protected $description = 'Eksekusi lgsg kirim email SP1 jika today = 7 + invoice duedate';
    ...
    {
        // get var from config
        $config = @MsConfig::where('name','start_sp1')->first()->value;
        if(!empty(@$config)){
            $day = $config;
        }else{
            $day = 7;
