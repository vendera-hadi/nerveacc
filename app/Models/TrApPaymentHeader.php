...
class TrApPaymentHeader extends Model
{
	...
	protected $table ='tr_ap_payment_hdr';
   	protected $fillable =['payment_date','amount','check_no','check_date','note','posting_at','created_by','updated_by','paymtp_id','posting_by','cashbk_id','spl_id','posting','pajak_id','pajak_amount'];
