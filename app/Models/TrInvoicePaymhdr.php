...
class TrInvoicePaymhdr extends Model
{
   ...
   protected $fillable =['invpayh_date','invpayh_checkno','invpayh_girodate','invpayh_note','invpayh_amount','invpayh_settlamt','invpayh_adjustamt','invpayh_post','created_by','updated_by','posting_at','paymtp_code','posting_by','cashbk_id','tenan_id','lunas','lebih_pembayaran'];
