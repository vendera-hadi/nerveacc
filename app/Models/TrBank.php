...
class TrBank extends Model
{
    ...
    protected $fillable = ['trbank_no','trbank_date','trbank_group','trbank_in','trbank_out','trbank_girodate','trbank_girono','trbank_charge','trbank_note','trbank_recipient','coa_code','trbank_rekon','trbank_post','posting_at','paymtp_id','cashbk_id','created_by','updated_by','kurs_id', 'currency_val'];
